...
# ... (funções de validação e cálculo continuam iguais) ...
...
# ... (todas as outras funções - ocr, cohere, pdfs, etc. - continuam aqui) ...
...
# ... (as outras páginas permanecem as mesmas) ...
